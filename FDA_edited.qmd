...
**Author**: [Massimo Lipari](https://massimolipari.github.io/)

This tutorial gives a brief overview of *functional principal components analysis* (FPCA) for linguistic data using existing `R` packages.  We use data from @puggaard-rode23 and @gubian_etal19a.
